...
st.markdown("<p style='text-align: center; opacity: 0.8; font-size: 1.2rem; margin-top: -15px;'>Chytrý pomocník pro studenty FM VŠE (funkční verze)</p>", unsafe_allow_html=True)
st.write("")
